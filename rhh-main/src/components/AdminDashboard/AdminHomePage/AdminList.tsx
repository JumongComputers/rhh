                          ...
                          currentItems.map((item: BookingTypes) => {
                            return (
                              <tr key={item?._id} className="text-xl text-center border-b border-[#E0E0E0] ">
                                ...
                                <td className="py-4">
                                  {/*The optional chaining operator ?. checks if the object to its left is not null or undefined. 
                                  If the object is null or undefined, the expression returns undefined without attempting to 
                                  access the property to its right (_id in this case). 
                                  This helps to prevent errors that would otherwise occur 
                                  if you tried to access properties of null or undefined objects directly. */}
