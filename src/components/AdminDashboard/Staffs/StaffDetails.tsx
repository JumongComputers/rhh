...
const StaffDetails: React.FC = () => {
  ...
  const currentItems = dummyData?.slice(indexOfFirstUser, indexOfLastUser);
  ...
  useEffect(() => {
    // Dispatch and other Redux-related code removed
  }, [dummyData, search]);
      ...
      <div className="px-4 py-6 font-[DM Sans] hidden lg:block">
        ...
        <div className="flex flex-row gap-2 justify-end w-full items-start mt-12">
          <ReactPaginate
            ...
            breakLabel={"..."}
            pageCount={Math.ceil(dummyData?.length / itemsPerPage)}
