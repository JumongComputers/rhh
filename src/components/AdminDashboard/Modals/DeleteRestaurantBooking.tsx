...
import { deleteRestaurantBooking } from "@/redux/slices/restaurantSlice";
...
const DeleteRestaurantBookingModal: React.FC<DeleteUserModalProps> = ({ visible, onClose, children, id }) => {
  ...
  const bookingDelete = (e: React.MouseEvent) => {
    ...
    dispatch(deleteRestaurantBooking(id) as any);
    onClose();
  };
...
export default DeleteRestaurantBookingModal;
